...
import AdminVerticalNavExpansionPanel from './AdminVerticalNavExpansionPanel'
...
const AdminVerticalNav = ({ items }) => {
    ...
    const renderLevels = (data) => {
        return data.map((item, index) => {
            ...
            if (item.children) {
                return (
                    <AdminVerticalNavExpansionPanel
                        mode={mode}
                        item={item}
                        key={index}
                    >
                ...
                return (
                    <NavLink
                        ...
                        className={clsx({
                            'flex justify-between h-60 border-radius-4 mb-2 compactNavItem whitespace-pre overflow-hidden': true,
                            [classes.navItem]: true,
                            [classes.compactNavItem]: mode === 'compact',
                        })}
                    >
...
export default React.memo(AdminVerticalNav)
